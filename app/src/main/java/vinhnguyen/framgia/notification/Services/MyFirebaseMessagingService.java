...
//    }
    ...
    private void sendRegistrationToServer(String token) {
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(
                Request.Method.POST,
                getString(R.string.api_url) + "devices",
                params,
    ...
    private void sendNotification(Map data) {
        ...
        Intent acceptIntent = createIntent(OrderRequestActivity.ACCEPT_ACTION);
        Intent rejectIntent = createIntent(OrderRequestActivity.REJECT_ACTION);
        Intent intent = createIntent(OrderRequestActivity.SHOW_ACTION);
